<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="{{url('/')}}/assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="{{url('/')}}/assets/images/profile_av.jpg" alt="User"></a>
                    <div class="detail">
                        <h4>Michael</h4>
            ...
            {{--                      <li><a href="{{route('admin.document')}}" class=" waves-effect waves-block"><i class="zmdi zmdi-folder"></i><span>Document</span></a></li> --}}
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>User Manager</span></a>
                <ul class="ml-menu {{ ( Request::is('admin.user') || Request::is('admin.user/*') ) ? 'active' : '' }}">
                    <li><a class="{{Route::current()->getName() == 'admin.user' ? 'active' : '' }}" href="{{route('admin.user')}}">All user</a></li>
{{--                     <li><a href="chat.html">Chat Apps</a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>File Manager</span></a>
                <ul class="ml-menu">
                    <li><a href="{{route('admin.document')}}">All File</a></li>
                    <li><a href="{{route('doctype')}}">Documents Type</a></li>
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Department</span></a>
                <ul class="ml-menu">
                    <li><a href="{{route('department')}}">All Department</a></li>
                </ul>
            </li>
